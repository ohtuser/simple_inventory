...
class SidebarController extends Controller
{
    public static function sidebar_write(){
        ...
        Sidebar::insert([
            ...
            ['module_name'=>'Product Management', 'group_name'=>'Category', 'name'=>'Category','icon'=> 'fas fa-bars', 'route'=>'admin.category.index','sort'=>1, 'permission_admin'=>1,'permission_stuff'=>1,'permission_customer'=>0,'status'=>1],
            ['module_name'=>'Product Management', 'group_name'=>'Category', 'name'=>'Sub Category','icon'=> 'fas fa-bars', 'route'=>'admin.sub_category.index','sort'=>1, 'permission_admin'=>1,'permission_stuff'=>1,'permission_customer'=>0,'status'=>1],
        ]);
