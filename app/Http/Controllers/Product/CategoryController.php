...
class CategoryController extends Controller
{
    ...
    public function list(){
        $data = ProductCategory::where('parent', null)->paginate(10);
    ...
    public function sub_category_index(){
        $categories = ProductCategory::where('parent', null)->get();
        return view('product.sub_category.index', compact('categories'));
    }

    public function sub_category_list(){
        $data = ProductCategory::with('getCategory')->where('parent', '!=', null)->paginate(10);
        // dd($data);
